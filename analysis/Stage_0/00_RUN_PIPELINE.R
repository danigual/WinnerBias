# analysis/Stage_0/00_RUN_PIPELINE.R

# ==============================================================================
# MASTER PIPELINE: STAGE 0 (Winner's Curse Simulation & Correction)
# ==============================================================================
#' DESCRIPTION:
#' This script orchestrates the sequential execution of the Stage 0 analysis.
#' It proceeds from synthetic data generation through GWAS to bias correction.
#' This stage is the control, characterized by a good sample size and 
#' high statistical power (There should be no winner's curse, or the effect 
#' should be low). For this reason, we will use this stage as a 
#' control on which we will vary the parameters to favor the winners' curse.
#'
#' PARAMETERS:
#' n_samples = 50000
#' n_snps    = 10000
...
#' 
#' EXECUTION FLOW:
#' 1.0 -> Power calculation (statistical_power.rds)
...
# ------------------------------------------------------------------------------
# --- STEP 1.0: Power calculation ---
message("\n>>> [1/6] Running 1.0: Power calculation")
source("analysis/Stage_0/1.0_power_calculation.R")

# --- STEP 1.1: Data Generation ---
message("\n>>> [2/6] Running 1.1: Dataset Generation...")
source("analysis/Stage_0/1.1_generate_datasets.R")

# --- STEP 1.2: GWAS ---
message("\n>>> [3/6] Running 1.2: GWAS Engine...")
source("analysis/Stage_0/1.2_run_gwas.R")

# --- STEP 1.3: Visualization ---
message("\n>>> [4/6] Running 1.3: Result Plots...")
source("analysis/Stage_0/1.3_plot_results.R")
