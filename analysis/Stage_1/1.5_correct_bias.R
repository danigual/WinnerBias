# analysis/Stage_1/1.5_correct_bias.R
...
message("\n[Step 1] Loading Stage 1 simulation data...")
sim_data_path <- "data/processed/Stage_1/simulacion_wc.rds"
gwas_res_path <- "data/processed/Stage_1/gwas_results.rds"
...
# Note: n_boot=100 is fast for testing. For the final work, consider n_boot=1000.
...
p_correction <- ggplot(winners_corrected) +
  ...
  labs(
    title = "Winner's Curse Correction: Stage 1",
...
# ------------------------------------------------------------------------------
# Save plot
fig_dir <- "output/figures/Stage_1"
if(!dir.exists(fig_dir)) dir.create(fig_dir, recursive = TRUE)
ggsave(file.path(fig_dir, "bias_correction_stage1.png"), p_correction, width = 7, height = 6)

# Save data for further analysis
saveRDS(winners_corrected, "data/processed/Stage_1/winners_corrected.rds")

message(paste("[Step 6] Analysis complete. Plot saved to", file.path(fig_dir, "bias_correction_stage1.png")))