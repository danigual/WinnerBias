...
#' This stage is characterized by a small sample size and therefore 
#' insufficient statistical power (<80%).This creates the conditions 
#' for the Winners Curse to appear.
#'
#' PARAMETERS:
#' n_samples = 5000
#' n_snps    = 10000
...
source("analysis/Stage_1/1.0_power_calculation.R")
